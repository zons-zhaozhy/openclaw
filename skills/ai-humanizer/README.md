...
- **Tier 1** (Dead giveaways): 50+ words that appear 5-20x more in AI text. Always flagged. Examples: _delve, tapestry, vibrant, crucial, meticulous, seamless, groundbreaking_
- **Tier 2** (Suspicious in density): 80+ words flagged when 2+ appear. Examples: _furthermore, paradigm, holistic, utilize, facilitate, nuanced_
- **Tier 3** (Context-dependent): 60+ words flagged only at >3% density. Examples: _significant, effective, unique, compelling, exceptional_
- **Phrases**: 80+ multi-word patterns. Examples: _"In today's digital age"_, _"plays a crucial role"_, _"serves as a testament"_
